...
(6, 'Ne le dis à personne', 9, 4.1, 'Huit ans après le meurtre brutal de sa femme, David Beck reçoit un message troublant semblant provenir d’elle. Tandis que les indices le poussent à croire qu’elle pourrait être encore vivante, il devient la cible d’une machination implacable mêlant criminels, policiers corrompus et secrets longtemps enfouis. Harlan Coben signe un thriller haletant centré sur la perte, l’espoir et la vérité, où les rebondissements s’enchaînent et où rien n’est jamais aussi simple qu’il n’y paraît.', 300, '2018-09-10 10:00:00', NULL, 5, 1),
...
(14, 'La Nuit des temps', 6, 4.6, 'Lorsqu’une équipe scientifique découvre dans l’Antarctique une civilisation ensevelie depuis des millénaires, le monde entier retient son souffle. Au cœur de la glace repose un couple figé dans un sommeil artificiel, héritiers d’un monde disparu. Le roman alterne exploration scientifique et récit d’amour tragique, questionnant les choix de société, la guerre et la fragilité des civilisations. Barjavel mêle poésie, science-fiction et émotion dans un récit intemporel.', 220, '2020-08-12 08:30:00', NULL, 13, 2),
...
(26, 'Persepolis', 7, 4.7, 'Marjane Satrapi raconte son enfance en Iran pendant la révolution islamique, oscillant entre traditions, répression et aspirations personnelles. À travers des illustrations simples et expressives, le récit aborde la perte de l’innocence, l’exil et la résistance individuelle face aux contraintes sociales et politiques. « Persepolis » est un témoignage poignant, alliant humour, émotion et réflexion sur la liberté et l’identité.', 300, '2019-09-10 12:00:00', NULL, 25, 3),
...
(38, 'Artemis Fowl', 4, 4.2, 'Artemis Fowl, jeune génie criminel, décide d’enlever une fée pour obtenir une rançon en or. Mais il se heurte à un monde féerique technologiquement avancé et à des créatures magiques bien plus rusées que prévu. Eoin Colfer construit un récit mêlant humour, stratégie, aventure et magie, où l’intelligence du héros se mesure à son sens moral et à ses choix.', 270, '2017-12-15 11:15:00', NULL, 39, 4),
...
(44, 'Germinal', 9, 4.6, 'Dans le nord de la France, Étienne Lantier s’engage dans la lutte des mineurs pour de meilleures conditions de travail. Émile Zola dépeint le quotidien difficile des ouvriers, les tensions sociales et la solidarité face à l’injustice. Roman naturaliste par excellence, Germinal allie réalisme brutal, critique sociale et profondeur humaine, offrant un tableau poignant des combats ouvriers au XIXe siècle.', 320, '2020-03-15 08:30:00', NULL, 44, 5),
...
(50, 'À l ombre des jeunes filles en fleurs', 3, 4.5, 'Marcel Proust continue son exploration de la mémoire et des sentiments à travers le regard du narrateur sur l’aristocratie française et les jeunes filles de son entourage. Ce deuxième tome d’À la recherche du temps perdu est un voyage introspectif mêlant élégance, observations sociales et poésie subtile.', 280, '2021-08-10 09:45:00', NULL, 50, 5),
...
(54, 'L Univers élégant', 6, 4.6, 'Brian Greene introduit la théorie des cordes et les concepts de physique moderne avec pédagogie, reliant cosmologie et mécanique quantique. L’auteur rend compréhensible la complexité de l’univers en expliquant les théories avancées tout en suscitant émerveillement et curiosité scientifique.', 300, '2020-03-15 08:30:00', NULL, 54, 6),
...
(56, 'La Structure des révolutions scientifiques', 4, 4.4, 'Thomas Kuhn analyse la manière dont la science progresse par révolutions et changements de paradigmes plutôt que par évolution continue. L’ouvrage questionne les fondements de la connaissance scientifique et son développement, influençant profondément la philosophie des sciences.', 280, '2019-09-10 12:00:00', NULL, 56, 6),
...
(65, 'L esprit des formes', 5, 4.3, 'Gaston Bachelard explore la perception des formes et des espaces dans la création artistique et poétique. Il analyse comment la forme influence notre imagination et nos émotions, proposant une approche philosophique et esthétique de l’art.', 120, '2019-09-10 12:00:00', NULL, 65, 7),
