...
--
-- Hôte : localhost
-- Généré le : lun. 24 nov. 2025 à 10:07
...
(15, '1984', 12, 4.9, 'Dans un régime totalitaire où Big Brother surveille chaque individu, Winston Smith tente de préserver sa liberté de pensée. Manipulation du langage, réécriture de l’Histoire et contrôle mental sont les armes d’un pouvoir oppressif qui broie tout esprit critique. À travers son héroïsme fragile, George Orwell questionne la vérité, la liberté et les dérives politiques. Ce roman visionnaire reste l’une des dystopies les plus marquantes et effrayantes du XXe siècle.', 500, '2017-09-01 10:00:00', '2018-04-22 12:00:00', 14, 2),
...
(51, 'Une brève histoire du temps', 10, 4.9, 'Stephen Hawking présente les concepts fondamentaux de la cosmologie moderne, expliquant les trous noirs, la relativité et l’origine de l’univers de manière accessible. L’auteur rend la science complexe compréhensible, mêlant rigueur et clarté, et invite le lecteur à réfléchir sur la nature du temps et de l’espace.', 520, '2017-09-01 10:00:00', '2018-03-10 12:00:00', 51, 6),
...
(1, 'user1', 'user1@gmail.com', '$2b$10$tQP4gO1vxkTCAR3T/L1m.usH31H9bSNWUEMWeUNZrn99/QaNIDaSK', 'adresse user1', '16000', 'Angouleme', '0600000000', 0, NULL, '2025-09-26 14:54:30', '2025-09-26 14:54:30', NULL, 1, NULL, NULL, NULL),
(2, 'user2', 'user2@gmail.com', '$2b$10$FoWa2blKhhjLsCkcgU9X7uZoy0Z1GyqTeIz/i6knbaaViF.tN6/xC', 'adresse user2', '16000', 'Angouleme', '0600000001', 0, NULL, '2025-09-26 14:54:36', '2025-10-18 06:56:32', NULL, 1, NULL, NULL, NULL),
(3, 'admin1', 'admin1@gmail.com', '$2b$10$U4GKvtXOHhr9Jz6VsoYPFeqKcUb/dKz0cLEQB421WPJn0uNlXT0jG', 'adresse amin1', '16000', 'Angouleme', '0600000002', 1, NULL, '2025-09-26 14:54:49', '2025-09-26 14:54:49', NULL, 1, NULL, NULL, NULL);
...
ALTER TABLE `books`
  ...
  ADD CONSTRAINT `books_ibfk_3` FOREIGN KEY (`authorId`) REFERENCES `authors` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
ALTER TABLE `book_users`
  ...
  ADD CONSTRAINT `book_users_ibfk_29` FOREIGN KEY (`bookId`) REFERENCES `books` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
